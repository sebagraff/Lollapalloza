...
public class LollapaloozaApplication {
	...
	public CommandLineRunner initData(ProductRepository productRepository){
		return(args) -> {
			...
			Product RemeraMusic = productRepository.save(new Product("Remera Lolla Music",1890.0,"Remera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo135671-c35bab1e9a71720ecd15959872334113-1024-1024.jpg"));
			Product RemeraMultiPride = productRepository.save(new Product("Remera Lolla Multi Pride",1890.0,"Remera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo135631-10a533a930b3c5ebde15959870535164-1024-1024.jpg"));
			Product RemeraTvSpiral = productRepository.save(new Product("Remera Lolla Tv Spiral",1890.0,"Remera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo135551-15b7cb05c138314ee115959867242967-1024-1024.jpg"));
			Product RemeraHeadphones = productRepository.save(new Product("Remera Lolla Headphones",1890.0,"Remera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo135341-09f44b40bb73fd5e2215959871790968-1024-1024.jpg"));
			Product RemeraShapes = productRepository.save(new Product("Remera Lolla Shapes",1890.0,"Remera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo135191-032146c6e713b1f28a15959869953160-1024-1024.jpg"));
			Product AccesorioPinLogo= productRepository.save(new Product("Pin Lolla Logo",290,"Pin","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129211-7391ece38c16a32e3315959768128717-320-0.jpg"));
			Product AccesorioPilusoMixNegro= productRepository.save(new Product("Piluso Lolla Mix Negro",1490.0,"Piluso","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo131541-c3ce36ac30201e480615959840839887-1024-1024.jpg"));
			Product AccesorioMaskMix= productRepository.save(new Product("Lolla Mask Mix",590.0,"Mask","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/seg-foto-accesorio-8-de-julio357661-0d5bf313a118da5e1b15959788940663-1024-1024.jpg"));
			...
			Product AccesorioMaskElectric= productRepository.save(new Product("Lolla Mask Electric",590,"Mask","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/seg-foto-accesorio-8-de-julio357721-11fa8948870a9f37ba15959798841171-1024-1024.jpg"));
			Product AccesorioMaskPride= productRepository.save(new Product("Lolla Mask Pride",590,"Mask","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/seg-foto-accesorio-8-de-julio357831-58725edcd02ebcb23815959796841195-1024-1024.jpg"));
			Product AccesorioRinoneraMix= productRepository.save(new Product("Riñonera Lolla Mix",990,"Riñonera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo132511-c383d3942f257f97c915959835091447-1024-1024.jpg"));
			...
			Product AccesorioPinMystery= productRepository.save(new Product("Pin Lolla Mystery",290,"Pin","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129161-f5afbeec21dcc3b05415959767263287-1024-1024.jpg"));
			Product AccesorioPinElectric= productRepository.save(new Product("Pin Lolla Electric",290,"Pin","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129061-27757f24fb0719500815959762995566-1024-1024.jpg"));
			...
			Product AccesorioPilusoMixVerde= productRepository.save(new Product("Piluso Lolla Mix Verde",1490.0,"Piluso","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo131581-c517f953e1914ddbd615959841306716-1024-1024.jpg"));
			...
			Product AccesorioStickersSpiral= productRepository.save(new Product("Set Stickers Lolla Spiral",360,"Stickers","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129681-84ea26f4439b5e925615959825071007-640-0.jpg"));
			...
			Product AccesorioBandanaPride= productRepository.save(new Product("Bandana Lolla Pride",590,"Bandana","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo131761-1605add398ec8c352415959690535649-640-0.jpg"));
			...
			Product AccesorioGorraElectric= productRepository.save(new Product("Gorra Lolla Electric",1990.0,"Gorra","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo131051-e20de35c16370165f215959851309380-640-0.jpg"));
			...
			Product AccesorioPinMusic= productRepository.save(new Product("Pin Lolla Music",290,"Pin","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129081-33d6ad77b44db659db15959764081461-640-0.jpg"));
			...
			Product AccesorioGorraBeach= productRepository.save(new Product("Gorra Lolla Beach",1990.0,"Gorra","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo130821-141ed75cd92232fbac15960301098809-640-0.jpg"));
			...
			Product AccesorioGorraPride= productRepository.save(new Product("Gorra Lolla Pride",1990.0,"Gorra","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo130981-ab01cc33ebf41a9acb15959850187989-640-0.jpg"));
			...
			Product AccesorioPinYellow= productRepository.save(new Product("Pin Lolla Yellow",290,"Pin","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129111-4cc57386a86756a35215959765074398-640-0.jpg"));
			Product AccesorioLlaveroVerde= productRepository.save(new Product("Llavero Lolla Mix Verde",390,"Llavero","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo129522-248545abf21099796e15959760036911-640-0.jpg"));
			...
			Product AccesorioBandanaMix= productRepository.save(new Product("Bandana Lolla Mix",590,"Bandana","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo1316811-63783d207f7b9022d115959688526735-640-0.jpg"));
			...
			Product AccesorioRinoneraMixRosa= productRepository.save(new Product("Riñonera Lolla Mix Rosa",990,"Riñonera","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo133471-7865b53aded7acb88915959833950706-640-0.jpg"));
			...
			Product AccesorioBandanaElectricNegro = productRepository.save(new Product("Bandana Lolla Electric Negro",590,"Bandana","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo132051-5ec0c19f37e1184f8d15959652394957-640-0.jpg"));
			...
			Product EcoVasos= productRepository.save(new Product("Vasos Lolla",85.0,"Vaso","",1000,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/merch_0012_img_1426-removebg-preview-png1-37b10cf9b7236df7cd16080748621512-1024-1024.jpg"));
			Product EcoCuadernoPide= productRepository.save(new Product("Cuaderno Lolla Pide",690,"Cuaderno","",100,"https://d2r9epyceweg5n.cloudfront.net/stores/698/172/products/sesion-sin-titulo130211-577723abcb9d16f0d115959776348637-640-0.jpg"));
