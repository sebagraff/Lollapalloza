...
import com.mindhub.Lollapalooza.repositories.ClientEventRepository;
...
public class LollapaloozaApplication {
	...
	public CommandLineRunner initData(ProductRepository productRepository,
		...
		return(args) -> {
			...
			//---------------------------------------------------------------Events----------------------------------------
			Event dia1 = eventRepository.save(new Event("VIERNES 27 DE MARZO", sede1));
			Event Dia2 = eventRepository.save(new Event("SABADO 28 DE MARZO",sede2));
			Event Dia3 = eventRepository.save(new Event("DOMINGO 29 DE MARZO",sede3));
